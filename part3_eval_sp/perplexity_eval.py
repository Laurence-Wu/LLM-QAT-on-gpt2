...
class PerplexityEvaluator:
    ...
    def _load_dataset(self, dataset_name: str) -> list:
        ...
        dataset_map = {'wikitext2': ('WikiText2', 'wikitext', 'wikitext-2-raw-v1', 'test', False), 'wikitext103': ('WikiText103', 'wikitext', 'wikitext-103-raw-v1', 'test', False), 'c4': ('C4', 'allenai/c4', 'en', 'validation', True)}
