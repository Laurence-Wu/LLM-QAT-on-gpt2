...
class ModelConfig:
    def __init__(self):
        ...
        self.lora_rank = 16
        self.lora_alpha = 32
        self.bit_widths = [3, 4, 5, 6, 8, 16, 24, 32]
        self.teacher_bits = 32
        self.lora_rank_per_bit = {3: 64, 4: 64, 5: 64, 6: 64, 8: 16, 16: 8, 24: 8, 32: 0}
        self.lora_alpha_per_bit = {3: 64, 4: 64, 5: 64, 6: 64, 8: 16, 16: 8, 24: 8, 32: 0}
        self.activation_bits_per_bit = {3: 3, 4: 4, 5: 5, 6: 6, 8: 8, 16: 16, 24: 24, 32: 32}
